...
.header-container { display: flex; justify-content: space-between; align-items:
center; border-bottom: 2px solid #ddd; padding-bottom: 10px; }
h1 { color: #333; margin: 0; }
.user-badge { background-color: #e3fcef; color: #006644; padding: 6px 12px; border-
radius: 20px; font-weight: bold; font-size: 14px; }
